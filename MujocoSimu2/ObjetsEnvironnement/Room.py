from MujocoSimu2.ObjetsEnvironnement.Button import Button
from MujocoSimu2.ObjetsEnvironnement.Door import Door
    ...
    def reset_room(self, model,
        ...
        for id_button in self.buttons_array.keys():
            if self.buttons_array[id_button].is_pressed == True:
                ...
                model.body(id_button).pos[2] = model.body(id_button).pos[2] + 0.04
